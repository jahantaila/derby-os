    ...
    <div className={cn("glass-card overflow-hidden rounded-2xl p-4 sm:p-5", className)}>
      <div className="animate-pulse space-y-4">
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="skeleton-shimmer h-4 w-16 rounded-full bg-white/10" />
        </div>
        <div className="skeleton-shimmer h-8 w-20 rounded-xl bg-white/10" />
        <div className="space-y-2">
          <div className="skeleton-shimmer h-3 w-full rounded-full bg-white/10" />
          <div className="skeleton-shimmer h-3 w-2/3 rounded-full bg-white/10" />
          <div className="skeleton-shimmer h-3 w-1/2 rounded-full bg-white/10" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className={cn("glass-panel rounded-2xl p-4 sm:p-5", className)}>
      <div className="animate-pulse space-y-3">
        <div className="skeleton-shimmer h-4 w-40 rounded-full bg-white/10" />
        {Array.from({ length: rows }, (_, index) => (
          <div key={index} className="glass-card rounded-2xl px-4 py-4">
            <div className="flex items-center justify-between gap-3">
              <div className="skeleton-shimmer h-3 w-1/3 rounded-full bg-white/10" />
              <div className="skeleton-shimmer h-3 w-20 rounded-full bg-white/10" />
            </div>
            <div className="skeleton-shimmer mt-3 h-3 w-2/3 rounded-full bg-white/10" />
          </div>
        ))}
      </div>
    </div>
