...
import { NotificationCenterPanel, NotificationCenterProvider, NotificationCenterTrigger } from "@/components/notification-center";
      ...
      <aside className="sidebar-shell">
        ...
        <div className="flex items-center justify-between gap-3 md:hidden">
          ...
          <div className="flex min-w-0 flex-1 items-center gap-3">
            ...
            <NotificationCenterTrigger className="relative inline-flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl border border-white/15 bg-slate-950/85 text-slate-100 transition hover:border-blue-300/45 hover:text-white" />
          </div>
        </div>

        {/* Desktop: icon rail */}
        <div className="hidden md:flex md:h-full md:flex-col md:items-center">
          <Link href="/" className="sidebar-logo-mark" aria-label="Derby Digital home">
          ...
          <nav className="sidebar-rail-nav" aria-label="Secondary">
            ...
            <NotificationCenterTrigger className="sidebar-rail-item" />
