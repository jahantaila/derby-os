...
export const seedTasks = [
  ...
  { id: "t2", title: "DerbyFlow WordPress plugin — Elementor dynamic tags + repeater", description: "Build WP plugin that pulls menu data from DerbyFlow API and renders via Elementor dynamic tags with repeater support", assignee: "Kevin", priority: "high", status: "in-progress", projectId: "p1", createdAt: "2026-03-02T17:00:00Z", dueDate: "2026-03-15", tags: ["derbyflow", "wordpress"], comments: 1 },
  { id: "t3", title: "Add sub-category support to DerbyFlow", description: "Add parentId to Category model in Prisma for nested sub-categories. Update store API and dashboard.", assignee: "Kimberly", priority: "high", status: "backlog", projectId: "p1", createdAt: "2026-03-02T20:00:00Z", dueDate: "2026-03-18", tags: ["derbyflow", "backend"], comments: 0 },
  { id: "t4", title: "Deep competitor research — Glassdoor + Trustpilot", description: "Dig into Glassdoor reviews for SpotHopper/Popmenu employee complaints, Trustpilot customer reviews, BBB complaints", assignee: "Kimberly", priority: "med", status: "review", projectId: "p5", createdAt: "2026-03-02T21:30:00Z", dueDate: "2026-03-09", tags: ["research", "competitors"], comments: 2 },
  { id: "t5", title: "Set up cold email outreach system", description: "Build repeatable cold email system targeting SpotHopper/BentoBox/Owner.com restaurant customers", assignee: "Kevin", priority: "high", status: "backlog", projectId: "p3", createdAt: "2026-03-02T16:00:00Z", dueDate: "2026-03-20", tags: ["outreach", "sales"], comments: 1 },
  { id: "t6", title: "Deploy DerbyFlow to Vercel", description: "Get the orderflow codebase deployed so we have a live API to build the WP plugin against", assignee: "Jahan", priority: "high", status: "backlog", projectId: "p1", createdAt: "2026-03-02T22:00:00Z", dueDate: "2026-03-11", tags: ["derbyflow", "deployment"], comments: 0 },
  { id: "t7", title: "Competitor intel posted to Discord", description: "Deep research on SpotHopper, BentoBox, Owner.com, Popmenu, Restaurant Growth with real pricing and user complaints from Reddit", assignee: "Kimberly", priority: "med", status: "done", projectId: "p5", createdAt: "2026-03-02T16:30:00Z", dueDate: "2026-03-05", tags: ["research", "competitors"], comments: 2 },
  { id: "t8", title: "Discord server setup — Derby Digital OS", description: "Built out full Discord server with Operations, Restaurant Division, Home Services, Marketing categories + channels", assignee: "Kevin", priority: "med", status: "done", projectId: "p6", createdAt: "2026-03-02T16:15:00Z", dueDate: "2026-03-04", tags: ["discord", "setup"], comments: 1 },
  { id: "t9", title: "Build Mission Control dashboard", description: "Next.js 14 custom dashboard with 14 screens for Derby Digital operations", assignee: "Kimberly", priority: "urgent", status: "in-progress", projectId: "p6", createdAt: "2026-03-03T00:30:00Z", dueDate: "2026-03-12", tags: ["mission-control"], comments: 0 },
  { id: "t10", title: "Write Sabri Suby ad templates for restaurants", description: "Create 5+ ad copy templates: direct response, social proof, urgency. For Facebook, Instagram, Google.", assignee: "Kevin", priority: "med", status: "review", projectId: "p5", createdAt: "2026-03-03T00:00:00Z", dueDate: "2026-03-14", tags: ["ads", "copy", "templates"], comments: 1 },
  { id: "t11", title: "Set up Brave Search API key", description: "Run openclaw configure --section web to enable deep web search", assignee: "Jahan", priority: "med", status: "backlog", projectId: "p6", createdAt: "2026-03-02T21:00:00Z", dueDate: "2026-03-10", tags: ["setup", "tools"], comments: 0 },
  { id: "t12", title: "Client onboarding checklist", description: "Create standardized onboarding process for new restaurant clients — repeatable system", assignee: "Kimberly", priority: "high", status: "backlog", projectId: "p5", createdAt: "2026-03-02T09:00:00Z", dueDate: "2026-03-13", tags: ["systems", "onboarding"], comments: 0 },
];
